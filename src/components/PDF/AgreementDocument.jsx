        ...
        <Document>
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={{ textAlign: 'justify' }}>
                        This Agreement, the construction and enforcement of its terms and the interpretation of the rights and duties of the parties hereto shall be subject to and governed by the laws of India. The parties hereby submit to the exclusive jurisdiction of the courts of <Text style={styles.bold}>Jaipur Rajasthan</Text> only. If any dispute or difference shall at any time arise between the Parties relating to or arising out of the terms of this Agreement (whether during the continuance of this Agreement or upon or after its termination), and no amicable resolution or settlement is reached within a period of Thirty (30) days, Such disputes and/or differences shall be subject to the exclusive jurisdiction of the courts of <Text style={styles.bold}>Jaipur Rajasthan</Text> only.
                    </Text>
                </View>
